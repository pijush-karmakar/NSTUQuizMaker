...
class BatchController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('vendor.multiauth.batch.index',compact('batches'));
    }
    ...
    {
         $degrees = Degree::all();
         return view('vendor.multiauth.batch.create',compact('degrees'));
    }
    ...
    public function edit($id)
    {
        $batch = Batch::find($id);
        $degrees = Degree::all();
        return view('vendor.multiauth.batch.edit',compact('batch','degrees'));
    }
